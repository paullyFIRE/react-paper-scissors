...
class GameHeaderControls extends React.Component {
    render() {
        return (
            ...
            <ControlButton eventHandler={this.props.eventHandler}>Reset Game</ControlButton>
            <ControlButton eventHandler={this.props.eventHandler}>Submit Score</ControlButton>
