        ...
        return (
            <Modal modalName={this.props.modalName}>
                ...
                <div className="modal-body">
                    ...
                    <ul>
                        <li>Winning a duel: <strong>1000 points</strong></li>
                        <li>Drawing a duel: <strong>250 points</strong></li>
                        <li>An extra <strong>1000 points</strong> per point difference against the opponent when you win!</li>
